...
RMC မှ Adv Auto Filter....

ရုပ်ရှင်များ ရှာပေးတဲ့ Bot ဖြစ်ပါတယ်။
Movies များရှာရန် RMC Request Group ကို Join ပေးပါနော် ။
👇👇
https://t.me/+HPXE9t6rejEzNDll

ရုပ်ရှင်နာမည်သာမှန်အောင်ရိုက် 😎😎
(ဘယ်ကားနေနေလင့်ရမယ်နော်😁😁)
...
🙋🏻‍♂️ 𝖳𝗎𝗍𝗈𝗋𝗂𝖺𝗅 𝖦𝗎𝗂𝖽𝖾 @KP_User_Guide
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/+HPXE9t6rejEzNDll)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
Message <b>: {}</b>"""
    ...
    CAPTION = """
📂 <em>File Name</em>: <code>|{file_caption}</code> 
